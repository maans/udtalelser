...
Hvis felterne er tomme, bruger appen standardreglen.

## Demo
Repo’et indeholder en demo-fil med opdigtede data:

- `demo_students.csv`

Den kan indlæses i **Indstillinger → Import** for at prøve appen uden rigtige elevdata. Du kan evt. omdøbe den til **students.csv**.
